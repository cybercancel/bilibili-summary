...
因为我不会上传导致main版是无gui老版本，master版是有gui新版本

实际上是因为找不到其他免费的类似项目所以选择自己做个，所以会在能用的前提下相当饭制

理论上是全网最便宜的视频总结（毕竟唯一花钱的地方就是全网最便宜的deepseek的最轻量api）

未来的更新方向应该是先把readme的配置界面尽可能地塞gui里，然后给程序做个接入知识库和封装两个大功能（当然现在全是幻想时刻）
---
...
- **多种通知**：默认禁用通知，因为我觉得可能会用上所以在ai写思路的时候加了，然后ai做了一些接口和框架，但是实际用起来发现通知这东西根本查无此人
